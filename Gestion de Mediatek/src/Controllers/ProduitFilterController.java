...
public class ProduitFilterController implements Initializable {
    ...
    public void initdata_srh(List<Produit> p) throws SQLException{
        ///////////
        int i = 0;
        int j = 0;
        int last = 0;
        for(Produit produit: p) {
            types_filter.getSelectionModel().select(produit.getType_pro());
